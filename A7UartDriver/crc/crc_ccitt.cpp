...
const unsigned short u16Crc16tab[256] =
{
...
static unsigned char	s_u8CRC_TABLE[]= {0x00,0x31,0x62,0x53,0xC4,0xF5,0xA6,0x97,0xB9,0x88,0xDB,0xEA,0x7D,0x4C,0x1F,0x2E};	 //CRC校验表
...
{
    unsigned int u32Cnt = 0x00;
    unsigned short u16Crc = *u16CheckOld;

    for( u32Cnt = 0; u32Cnt < u32Len; u32Cnt++)
        u16Crc = (u16Crc<<8) ^ u16Crc16tab[((u16Crc>>8) ^ *(unsigned char *)u8Buf++)&0x00FF];
    *u16CheckOld = u16Crc;
